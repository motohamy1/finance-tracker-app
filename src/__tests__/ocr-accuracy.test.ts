...
const testCases: TestCase[] = [
  // ─── Robinhood (5 cases) ───
  {
    ...
    groundTruth: { ticker: 'AAPL', shares: 10, pricePerShare: 185.50, tradeDate: '2026-04-28', direction: 'buy', feesCents: null, rawText: '', confidence: 1.0 },
  },
  {
    platform: 'robinhood',
    description: 'Market Sell with limit price',
    rawText: 'Robinhood Financial\nMarket Sell\nTSLA\n5 shares\nat $250.00\nLimit Price: $245.00\nMay 01, 2026',
    groundTruth: { ticker: 'TSLA', shares: 5, pricePerShare: 250.00, tradeDate: '2026-05-01', direction: 'sell', feesCents: null, rawText: '', confidence: 1.0 },
  },
  {
    platform: 'robinhood',
    description: 'Order Buy with fractional shares',
    rawText: 'RH\nOrder Buy\nGOOGL\n3 shares\nat $175.25\nApr 15, 2026\nDay Order',
    groundTruth: { ticker: 'GOOGL', shares: 3, pricePerShare: 175.25, tradeDate: '2026-04-15', direction: 'buy', feesCents: null, rawText: '', confidence: 1.0 },
  },
  {
    platform: 'robinhood',
    description: 'Stop Loss order (sell)',
    rawText: 'Robinhood\nStop Loss\nSell\nNVDA\n20 shares\nStop Price: $120.00\nMar 22, 2026\nGTC',
    groundTruth: { ticker: 'NVDA', shares: 20, pricePerShare: 120.00, tradeDate: '2026-03-22', direction: 'sell', feesCents: null, rawText: '', confidence: 1.0 },
  },
  {
    platform: 'robinhood',
    description: 'Buy with fractional price',
    rawText: 'Robinhood\nMarket Buy\nMETA\n15 shares\nat $512.75\nApr 30, 2026',
    groundTruth: { ticker: 'META', shares: 15, pricePerShare: 512.75, tradeDate: '2026-04-30', direction: 'buy', feesCents: null, rawText: '', confidence: 1.0 },
  },
  ...
  // ─── Webull (5 cases) ───
  {
    ...
    groundTruth: { ticker: 'AAPL', shares: 10, pricePerShare: 186.00, tradeDate: '2026-04-28', direction: 'buy', feesCents: null, rawText: '', confidence: 1.0 },
  },
  {
    platform: 'webull',
    description: 'Order Filled sell',
    rawText: 'Webull Securities\nOrder Filled\nSold 5 TSLA @ $248.00\nFilled Price: $248.00\nTotal: $1,240.00\nApr 29 2026',
    groundTruth: { ticker: 'TSLA', shares: 5, pricePerShare: 248.00, tradeDate: '2026-04-29', direction: 'sell', feesCents: null, rawText: '', confidence: 1.0 },
  },
  {
    platform: 'webull',
    description: 'Buy with Qty notation',
    rawText: 'WEBULL FINANCIAL\nOrder Status: Filled\nBought\nAMD\nQty: 50\nAvg Price: $95.30\nTotal Cost: $4,765.00\nMay 01 2026',
    groundTruth: { ticker: 'AMD', shares: 50, pricePerShare: 95.30, tradeDate: '2026-05-01', direction: 'buy', feesCents: null, rawText: '', confidence: 1.0 },
  },
  {
    platform: 'webull',
    description: 'Sell with partial fill',
    rawText: 'Webull Financial LLC\nSold\nMSFT\n20 shares\nFilled Price: $420.00\nApr 20 2026',
    groundTruth: { ticker: 'MSFT', shares: 20, pricePerShare: 420.00, tradeDate: '2026-04-20', direction: 'sell', feesCents: null, rawText: '', confidence: 1.0 },
  },
  {
    platform: 'webull',
    description: 'Buy penny stock',
    rawText: 'Webull\nBought\nSNDL\n100 shares\nFilled Price: $1.85\nTotal Cost: $185.00\nMar 15 2026',
    groundTruth: { ticker: 'SNDL', shares: 100, pricePerShare: 1.85, tradeDate: '2026-03-15', direction: 'buy', feesCents: null, rawText: '', confidence: 1.0 },
  },
  ...
  // ─── eToro (5 cases) ───
  {
    ...
    groundTruth: { ticker: 'AAPL', shares: 3, pricePerShare: 186.50, tradeDate: '2026-04-28', direction: 'buy', feesCents: null, rawText: '', confidence: 1.0 },
  },
  {
    platform: 'etoro',
    description: 'Close Trade (sell)',
    rawText: 'eToro (Europe)\nClose Trade\nTSLA\nInvestment amount: $1,000.00\nOpen Rate: $245.00\nClose Rate: $260.00\nProfit: $61.22\nMay 01 2026',
    groundTruth: { ticker: 'TSLA', shares: 4, pricePerShare: 245.00, tradeDate: '2026-05-01', direction: 'sell', feesCents: null, rawText: '', confidence: 1.0 },
  },
  {
    platform: 'etoro',
    description: 'Open Trade with leverage',
    rawText: 'eToro\nOpen Trade\nNVDA\nInvestment amount: $200.00\nRate: $125.30\nStop Loss: $120.00\nLeverage: x5\nApr 15 2026',
    groundTruth: { ticker: 'NVDA', shares: 2, pricePerShare: 125.30, tradeDate: '2026-04-15', direction: 'buy', feesCents: null, rawText: '', confidence: 1.0 },
  },
  {
    platform: 'etoro',
    description: 'Close Trade with profit',
    rawText: 'eToro Europe\nClose Trade\nGOOGL\nInvestment amount: $800.00\nOpen Rate: $170.00\nClose Rate: $178.50\nProfit: $40.00\nApr 30 2026',
    groundTruth: { ticker: 'GOOGL', shares: 5, pricePerShare: 170.00, tradeDate: '2026-04-30', direction: 'sell', feesCents: null, rawText: '', confidence: 1.0 },
  },
  {
    platform: 'etoro',
    description: 'Open Trade large investment',
    rawText: 'eToro\nOpen Trade\nAMZN\nInvestment amount: $2,000.00\nRate: $195.00\nStop Loss: $185.00\nTake Profit: $210.00\nApr 22 2026',
    groundTruth: { ticker: 'AMZN', shares: 10, pricePerShare: 195.00, tradeDate: '2026-04-22', direction: 'buy', feesCents: null, rawText: '', confidence: 1.0 },
  },
];
